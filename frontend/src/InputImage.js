...
export default function InputImage(props) {
  ...
  const predictImage = () => {
    const food = 'pizza'; // contoh
    const appID = process.env.EDAMAM_KEY;
    const appKey = process.env.EDAMAM_APP_ID;
    const url = `https://api.edamam.com/search?q=${food}&app_id=${appID}&app_key=${appKey}`;
